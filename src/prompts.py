...
zero_shot_prompt = ChatPromptTemplate.from_messages(
    [
        ...
        (
            "human",
            "You are given a code snippet written in {language}. Your task is to generate clear and concise documentation for the provided code itself, i.e. docstrings or javadoc for this code snippet. "
